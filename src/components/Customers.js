...
export default() => {
  ...
  return (
      ...
      <div className="column is-one-third">
        ...
        <div className="customer column is-one-third">
          <Influencer url='https://useflaunt.com' imgUrl='url("https://s3.amazonaws.com/flauntappbucket/checkout_pages@2x.png")' title='Flaunt' subtitle='The easiest way to build a subscription checkout page -- without code' hexColor="#f3a4b5"/>
        </div>
        <div className="customer column is-one-third">
